...
st.caption(
    "A computational physics simulator for circular motion, "
...
st.sidebar.info(
    "This simulator uses numerical physics calculations "
    ...
    fig.add_trace(
        go.Scatter(
            x=[
                current_position[0],
                current_position[0]
                + current_velocity[0] * vector_scale,
            ],
            y=[
                current_position[1],
                current_position[1]
                + current_velocity[1] * vector_scale,
            ],
            mode="lines",
            name="Velocity",
            line=dict(width=4),
...
# ============================================================
    ...
    st.markdown(
        """
        For an object to maintain contact throughout a
        vertical circle, the minimum speed at the top must satisfy:
        """
    )
...
# ============================================================
    ...
    st.markdown(
        """
        The Coriolis effect appears when motion is observed
